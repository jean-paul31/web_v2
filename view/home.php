            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="http://mediaschool.jean-pauldev.fr/index.php" class="btn btn-primary" target="_blank">Visitez ce site</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="https://editions-le-passe-monde.com/" class="btn btn-primary" target="_blank">Visitez ce site</a>
                    </div>
                </div>
            </div>
